...
<head>
	...
	<meta name="google-site-verification" content="SO0ROlSy8iSBZ2PwnnzGsN02MyfEMSbQWVQy_DUagmE" />
	...
	<div id="header"><header>
		<div class="container">
			<div id="title">
                ...
                <div id="headerQuote"><img src="/wp-content/themes/stranger_dreams/images/cave_you_fear.png"/></div>
                <div id="betaCode"><a href="/station/" title="Head to the station."><?php if(is_page('station') || get_post_type() == 'destination' ) { ?><img src="/wp-content/themes/stranger_dreams/images/beta_code_station.png" alt="Have a beta code? Head to the station."/><?php } else { ?><img src="/wp-content/themes/stranger_dreams/images/beta_code.png" alt="Have a beta code? Head to the station."/><?php } ?></a></div>
			</div><!--#title-->
