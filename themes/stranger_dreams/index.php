<?php get_header(); ?>
	<div id="content">
		<?php if( is_category() || is_tag() || is_search() || is_home() || is_single() ) { ?><div class="hentry"><h1>Journal: A Development Blog</h1></div><?php } ?>
...
<?php if( is_category() || is_tag() || is_search() || is_home() || is_single() ) get_sidebar(); ?>
<?php get_footer(); ?>